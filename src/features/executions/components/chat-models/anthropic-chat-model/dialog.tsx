...
import { getAvailableAnthropicModels } from "./actions";
...
export type AnthropicChatModelFormValues = z.infer<typeof formSchema>;

interface Props {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    onSubmit: (values: AnthropicChatModelFormValues) => void;
    defaultValues?: Partial<AnthropicChatModelFormValues>;
}

export const AnthropicChatModelDialog = ({
    open,
    onOpenChange,
    onSubmit,
    defaultValues = {},
    ...
    const form = useForm<AnthropicChatModelFormValues>({
    ...
    const handleCredentialCreated = (credentialId: string) => {
        ...
        queryClient.invalidateQueries(trpc.credentials.getByType.queryOptions({ type: CredentialType.ANTHROPIC }));

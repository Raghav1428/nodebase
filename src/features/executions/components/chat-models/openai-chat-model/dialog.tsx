...
export type OpenAIChatModelFormValues = z.infer<typeof formSchema>;

interface Props {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    onSubmit: (values: OpenAIChatModelFormValues) => void;
    defaultValues?: Partial<OpenAIChatModelFormValues>;
}

export const OpenAIChatModelDialog = ({
    open,
    onOpenChange,
    onSubmit,
    defaultValues = {},
    ...
    const form = useForm<OpenAIChatModelFormValues>({
    ...
    const handleCredentialCreated = (credentialId: string) => {
        ...
        queryClient.invalidateQueries(trpc.credentials.getByType.queryOptions({ type: CredentialType.OPENAI }));
                                                ...
                                                {credentials?.map((credential) => (
                                                    <SelectItem key={credential.id} value={credential.id}>
                                                        <div className="flex items-center gap-2">
                                                            <Image src="/logos/openai.svg" alt="OpenAI" width={16} height={16} className="dark:invert" />

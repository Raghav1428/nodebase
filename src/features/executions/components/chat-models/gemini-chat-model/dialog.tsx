...
export type GeminiChatModelFormValues = z.infer<typeof formSchema>;

interface Props {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    onSubmit: (values: GeminiChatModelFormValues) => void;
    defaultValues?: Partial<GeminiChatModelFormValues>;
}

export const GeminiChatModelDialog = ({
    open,
    onOpenChange,
    onSubmit,
    defaultValues = {},
    ...
    const form = useForm<GeminiChatModelFormValues>({
    ...
    const handleCredentialCreated = (credentialId: string) => {
        ...
        queryClient.invalidateQueries(trpc.credentials.getByType.queryOptions({ type: CredentialType.GEMINI }));

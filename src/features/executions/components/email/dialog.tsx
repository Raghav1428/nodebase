...
export const EmailDialog = ({
    ...
    const [addCredentialType, setAddCredentialType] = useState<CredentialType>(CredentialType.EMAIL_GMAIL);
    ...
    const handleCredentialCreated = (credentialId: string) => {
        // Invalidate both credential type queries to refetch the lists
        queryClient.invalidateQueries(trpc.credentials.getByType.queryOptions({ type: CredentialType.EMAIL_SMTP }));
        queryClient.invalidateQueries(trpc.credentials.getByType.queryOptions({ type: CredentialType.EMAIL_GMAIL }));
    ...
    return (
        <>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <Select
                                            onValueChange={(value) => {
                                                if (value === "__add_gmail__") {
                                                    handleAddCredential(CredentialType.EMAIL_GMAIL);
                                                } else if (value === "__add_smtp__") {
                                                    handleAddCredential(CredentialType.EMAIL_SMTP);
                                                } else {
                                        ...
                                        >
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectItem value="__add_gmail__" className="hover:text-primary">
                                                    <div className="flex items-center gap-2">
                                                        <Plus className="h-4 w-4" />
                                                        <span>Add Gmail credential...</span>
                                                    </div>
                                                </SelectItem>
                                                <SelectItem value="__add_smtp__" className="hover:text-primary">
                                                    <div className="flex items-center gap-2">
                                                        <Plus className="h-4 w-4" />
            ...
            <AddCredentialDialog
                ...
                credentialType={addCredentialType}
